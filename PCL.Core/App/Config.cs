...
public static partial class Config
{
    ...
    [ConfigGroup("Update")] partial class UpdateConfigGroup
    {
        ...
        /// 自动更新行为。
        /// </summary>
        [ConfigItem<LauncherAutoUpdateBehavior>("SystemSystemUpdate", LauncherAutoUpdateBehavior.DownloadAndInstall, ConfigSource.Local)] public partial LauncherAutoUpdateBehavior UpdateMode { get; set; }
    ...
    [ConfigGroup("Preference")] partial class PreferenceConfigGroup
    {
        ...
        /// 窗口标题文本。
        /// </summary>
        [ConfigItem<string>("UiLogoText", "千星", ConfigSource.Local)] public partial string WindowTitleCustomText { get; set; }
        ...
        partial class HideConfigGroup
        {
            ...
            [ConfigItem<bool>("UiHiddenPageServer", false, ConfigSource.Local)] public partial bool PageServer { get; set; }
            ...
            // 子页面 服务器
            [ConfigItem<bool>("UiHiddenServerStatus", false, ConfigSource.Local)] public partial bool ServerStatus { get; set; }
    ...
    [ConfigGroup("Launch")] partial class LaunchConfigGroup
    {
        ...
        /// 自定义左下角版本信息。
        /// </summary>
        [ConfigItem<string>("LaunchArgumentInfo", "千星启动器", ConfigSource.Local)] public partial string TypeInfo { get; set; }
