...
public partial class PageDownloadLeft : IRefreshable
{
    ...
    public PageDownloadLeft()
    {
        ...
        ItemMod.SetChecked(true, false, false);

        
        foreach (var item in new[] { ItemInstall, ItemPack, ItemWorld, ItemClient, ItemOptiFine, ItemForge, ItemNeoForge, ItemLiteLoader, ItemFabric, ItemLegacyFabric, ItemLabyMod, ItemCleanroom })
        {
